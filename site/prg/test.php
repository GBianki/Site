...
if ($_REQUEST['sessao'] == 'get') {
	...
	if($sessao == $valor)
		echo "<b>SUCESSO</b><br>\nA sess&atilde;o guardou o valor [ $valor ] $encoding";
	else 
		echo "<b>ERRO</b><br>\nFoi gravado o valor [ $valor ] e a sess&atilde;o guardou o valor [ $sessao ]";
	exit();
} else if ($_REQUEST['sessao'] == 'set') {
	session_start(); 
	$_SESSION['valor'] = $valor ;
	echo "Voc&ecirc; gravou na sess&atilde;o o valor [ $valor ] $encoding<br>\n";
	echo "Clique no link para abrir outra p&aacute;gina e ler o valor na sess&atilde;o:\n
