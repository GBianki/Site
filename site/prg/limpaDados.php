...
$MesesNoSiteCond = Configuracao("MESES_NO_SITE_EXTRATOCOND", Configuracao("MESES_NO_SITE", 3)); 
$MesesNoSiteLoc = Configuracao("MESES_NO_SITE_DEMONSTRATIVOLOC", $MesesNoSiteCond);
