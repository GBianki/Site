...
$Caracs = Campo('cbCarac');
$iLenCaracs = count($Caracs);
...
//print "<!-- Vagas $NroVagas -->\n";
			...
			if ($iCont == 0 && ($bTodosDorm || $bTodosTipos)) {
				...
				if ($exibeThumbNails)
				{
					$model->assign('PRIMEIRACOL', '0%');
					$model->assign('SEGUNDACOL', '100%');
					$model->assign('TERCEIRACOL', '0%');
					$model->assign('ESTILOPRIMEIRACOL', 'display: none;');
					$model->assign('ESTILOSEGUNDACOL', '');
					$model->assign('TAGSEGUNDACOL', "colspan=\"3\"");
					$model->assign('ESTILOTERCEIRACOL', 'display: none;');
			...
			if ($exibeThumbNails)
			{
				...
				// Campos do Mauricio
				$model->assign('PRIMEIRACOL', '27%');
				$model->assign('SEGUNDACOL', '48%');
				$model->assign('TERCEIRACOL', '25%');
				$model->assign('ESTILOPRIMEIRACOL', '');
				$model->assign('ESTILOSEGUNDACOL', '');
				$model->assign('ESTILOTERCEIRACOL', '');
				$model->assign('TAGSEGUNDACOL', "");
...
$model->assign('BARRADEPESQUISA', $searchBar);
